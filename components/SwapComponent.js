...
import { CogIcon, ArrowSmDownIcon } from "@headlessui/react";
 ...
 const SWAP = "Swap"; 
  ...
  const destTokenObj = {
   ...
   useEffect(() => {
    ...
    setSrcTokenComp(<SwapField obj={destTokenObj} ref={outputValueRef} />);
    ...
    {/* <CogIcon className="h-6" /> */}
      ...
      <div className=" relative border-[2px] rounded-xl bg-[#212429] w-[100%] p-4 px-6 mb-2 border-transparent hover:border-zinc-600 ">
    {srcTokenComp}
